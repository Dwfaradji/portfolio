  ...
  <div class="parent">
    ...
    <div class="row justify-content-between">
      <div class="col-md-7">
        ...
        <h3>
          <i class="fas fa-check-circle text-danger mr-2 check"></i>APPLICATIONS
          SPÉCIFIQUES ET INTERFACE D'ADMINISTRATION
        </h3>
        ...
        <h3>
          <i class="fas fa-check-circle text-danger mr-2 check"></i>INTÉGRATION
          (X)HTML / CSS
        </h3>
        <p>Codage à la main respectueux des standards du Web</p>
        <h3>
          <i class="fas fa-check-circle text-danger mr-2 check"></i>DYNAMISE DES
          PAGES PAR JAVASCRIPT / AJAX
        </h3>
      ...
      <div>
        ...
        <div class="mt-5 col-md-12">
          <div class="bar mb-4 progress progress2">
            <div
            ...
            >
              <div class="anim-text">
                <span class="text-left ml-3 font-weight-bold"
                  >(X)HTML - CSS</span
                >
              </div>
            </div>
          ...
          <div class="bar mb-4 progress">
            <div
              class="progress-bar bar color2"
              role="progressbar"
              style="width: 50%"
              aria-valuenow="15"
              aria-valuemin="0"
            ...
            >
              <div class="anim-text">
                <span class="text-left ml-3 font-weight-bold">VUE JS</span>
              </div>
            </div>
          </div>
          <div class="bar mb-4 progress">
            <div
              class="progress-bar bar color3"
              role="progressbar"
              style="width: 60%"
              aria-valuenow="15"
              aria-valuemin="0"
            ...
            >
              <div class="anim-text">
                <span class="text-left ml-3 font-weight-bold">MYSQL - SQL</span>
              </div>
            </div>
          </div>
          <div class="bar mb-4 progress">
            <div
              class="progress-bar bar color4"
              role="progressbar"
              style="width: 70%"
              aria-valuenow="15"
              aria-valuemin="0"
